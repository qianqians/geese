...
def parser(_str:str):
    ...
    machine.syntaxanalysis(deletenote(_str))
...
def batch(inputdir, commondir):
    ...
    for filename in os.listdir(inputdir):
        ...
        if fex == '.juggle':
            ...
            pretreatmentdata.append(pretreatment(fname, _import, module, enum, struct))
    ...
    if commondir is not None:
        ...
        for filename in os.listdir(commondir):
            ...
            if fex == '.juggle':
                ...
                pretreatmentdata_import.append(pretreatment(fname, _import, {}, enum, struct))
        pretreatmentdata.extend(pretreatmentdata_import)
        
    process(pretreatmentdata)
