...
def parameter_check(type_str:str, parameter_str:str):
    try:
        if type_str == "int8":
...
def parameter_int8_check(parameter_str:str):
    p = int(parameter_str)
    return p >= -128 and p <= 127

def parameter_int16_check(parameter_str:str):
    p = int(parameter_str)
    return p >= -32768 and p <= 32767

def parameter_int32_check(parameter_str:str):
    p = int(parameter_str)
    return p >= -2147483648 and p <= 2147483647

def parameter_int64_check(parameter_str:str):
    return True

def parameter_uint8_check(parameter_str:str):
    p = int(parameter_str)
    return p >= 0 and p <= 255

def parameter_uint16_check(parameter_str:str):
    p = int(parameter_str)
    return p >= 0 and p <= 65535

def parameter_uint32_check(parameter_str:str):
    p = int(parameter_str)
    return p >= 0 and p <= 4294967295

def parameter_uint64_check(parameter_str:str):
    return True

def parameter_float_check(parameter_str:str):
    p = float(parameter_str)
    return True

def parameter_double_check(parameter_str:str):
    p = float(parameter_str)
    return True

def parameter_bool_check(parameter_str:str):
    if parameter_str == "true" or parameter_str == "false":
        return True
    return False

def parameter_string_check(parameter_str:str):
    if parameter_str[0] == "\"" and parameter_str[-1] == "\"":
        return True
    return False

def parameter_bin_check(parameter_str:str):
    if parameter_str[0] == "[" and parameter_str[-1] == "]":
