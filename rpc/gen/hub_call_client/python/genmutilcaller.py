...
def gen_mutil_caller(module_name, funcs, dependent_struct, dependent_enum, enum):
    code = "class " + module_name + "_caller(object):\n"
    code += "    def __init__(self, entity:player|entity):\n"
        ...
        if i[1] == "ntf":
            ...
            for _type, _name, _parameter in i[2]:
                ...
                code += gen_type_code_type_to_protcol(
                    ...
                    dependent_struct, 
                    dependent_enum)
            code += "        self.entity.call_client_mutilcast(\"" + func_name + "\", dumps(_argv_" + _argv_uuid + "))\n\n"
