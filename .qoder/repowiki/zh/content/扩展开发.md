...
- [crates/scene/src/animation.rs](file://crates/scene/src/animation.rs)
- [crates/scene/src/animation_graph.rs](file://crates/scene/src/animation_graph.rs)
...
- [crates/tcp/src/lib.rs:1-3](file://crates/tcp/src/lib.rs#L1-L3)
- [crates/wss/src/lib.rs:1-4](file://crates/wss/src/lib.rs#L1-L4)
- [crates/scene/src/animation.rs:105-139](file://crates/scene/src/animation.rs#L105-L139)
- [crates/scene/src/animation_graph.rs:100-322](file://crates/scene/src/animation_graph.rs#L100-L322)
...
**图表来源**
- [crates/scene/src/animation_graph.rs:100-322](file://crates/scene/src/animation_graph.rs#L100-L322)
- [crates/scene/src/animation.rs:68-139](file://crates/scene/src/animation.rs#L68-L139)
...
- 模块耦合
  ...
  - **scene 依赖 animation 和 animation_graph 模块**，提供完整的动画系统支持。
- 外部依赖
...
SCENE --> CAMERA["camera"]
SCENE --> MATH["math"]
SCENE --> ANIM["animation"]
SCENE --> ANIM_GRAPH["animation_graph"]
ANIM --> CGMATH["cgmath"]
ANIM_GRAPH --> CGMATH
ASSET --> GLTF["gltf"]
```
...
- **在场景层实现基于状态机的动画图系统，支持参数驱动和混合动画，提升角色动画的灵活性与表现力**；
