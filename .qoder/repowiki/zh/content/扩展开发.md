...
## 架构总览
下图展示了从场景到渲染器再到 GPU 的整体流程，以及网络层的抽象与协议实现。**动画系统现在通过 avatar crate 提供高级功能，scene 模块负责集成和使用这些功能**。
...
App->>Scene : "更新动画/变换"
Scene->>Avatar : "使用 AnimationStateMachine"
Avatar-->>Scene : "返回 ActiveAnimation 列表"
...
- [crates/avatar/src/animation_graph.rs:178-299](file://crates/avatar/src/animation_graph.rs#L178-L299)
...
## 结论
geese 的扩展开发围绕"场景-渲染-网络"三大主线展开。**通过将动画系统重构到独立的 avatar crate，开发者现在可以**：
